        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="reveal delay-200 lg:col-span-7 relative aspect-square max-w-[640px] mx-auto w-full">
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="relative z-10 w-20 h-20 rounded-full bg-[var(--bg-card)] border border-[var(--red)]/40 flex items-center justify-center shadow-[0_0_40px_rgba(239,68,68,0.35)]">
                <img src="/logo.png" alt="ATS" className="w-12 h-12 object-contain p-1 bg-white rounded-full" />
              </div>
            </div>
          </div>
        </div>
